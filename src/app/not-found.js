  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-linear-to-b from-orange-100 via-white to-green-100 text-center px-6 relative overflow-hidden mt-16">
      ...
      <h2 className="text-3xl font-semibold text-gray-800 mb-2">
        Arrey! Page Nahi Mili 😅
      </h2>
      <p className="text-gray-600 mb-8 max-w-md">
        Lagta hai aap galat raaste par aa gaye ho.
        <br /> The page you’re looking for doesn’t exist or might have moved.
      </p>
      ...
      {/* Footer note */}
      <p className="text-xs text-gray-500 mt-8"> Made with ❤️ in India </p>
